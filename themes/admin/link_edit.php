                    ...
                    <div class="panel-body">
						<form accept-charset="UTF-8" action="<?php echo site_url('admin/links/edit/'.$link['id']);?>" class="simple_form form-horizontal" id="edit_user_1" method="post" novalidate="novalidate">
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<input class="form-control" id="name" name="name" size="50" type="text" value="<?php echo $link['name']?>" />
								</div>
							</div>
							<div class="form-group email optional">
								<label class="col-md-3 control-label" for="url">网址</label>
								<div class="col-md-5">
									<input class="form-control" id="url" name="url" size="50" type="email" value="<?php echo $link['url']?>" />
								</div>
							</div>
							<div class="form-group string optional">
								...
								<div class="col-md-5">
									<label class='radio-inline'>
										<input<?php if($link[ 'is_hidden']=='0'){?> checked="checked"<?php }?> id="settings_show_community_stats_on" name="is_hidden" type="radio" value="0" />显示</label>
									<label class='radio-inline'>
										<input<?php if($link['is_hidden']=='1'){?> checked="checked"<?php }?> id="settings_show_community_stats_off" name="is_hidden" type="radio" value="1" />隐藏</label>
								</div>
							</div>
							<div class="form-group">
